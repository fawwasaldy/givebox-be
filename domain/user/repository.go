...
type (
	Repository interface {
		...
		GetUserByUsername(ctx context.Context, tx interface{}, username string) (User, error)
		CheckUsername(ctx context.Context, tx interface{}, username string) (User, bool, error)
